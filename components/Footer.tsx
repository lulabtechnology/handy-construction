  ...
  return (
    <footer className="border-t border-slate-200">
      <div className="container-narrow py-8 text-sm text-slate-600 grid gap-4 md:grid-cols-3">
        <div>
          <div className="font-semibold">Handy Construction S.A</div>
      ...
      <div className="text-center text-xs text-slate-500 pb-6">© {new Date().getFullYear()} Handy Construction S.A — Todos los derechos reservados</div>
    </footer>
  );
}
